...
export default function PropertyTypes() {
  ...
  return (
    <section id="property-types" className="py-10 lg:py-20 bg-gradient-to-b from-white via-slate-50/80 to-white relative overflow-hidden border-b border-slate-200">
