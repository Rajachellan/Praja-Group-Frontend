...
import PropertyManagementAnimationProps from './Animation'
     ...
     <section className="relative pt-40 sm:pt-44 lg:pt-48 pb-20 bg-gradient-to-b from-[#F4F8F6] via-white to-[#F8FAFC] border-b border-slate-100 overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <nav className="flex items-center gap-2 text-xs font-semibold text-slate-500 uppercase tracking-widest mb-6">
            ...
            <span className="text-[#F37924] font-bold">Property Management</span>
          </nav>
            ...
            <div className="lg:col-span-7 xl:col-span-6 space-y-6 text-left">
              ...
              <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-[#166534]/20 bg-[#F0FDF4] shadow-sm">
                ...
                <span className="text-xs font-bold uppercase tracking-wider ">
                 PRAJHA PROPERTY MANAGEMENT • NRI CARETAKING & ESTATE CARE
                </span>
              </div>

              {/* Main Headline */}
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[52px] font-bold text-black leading-[1.12]  mb-5 heading">
               Protecting Your Property. <br className="hidden sm:inline" />
                in <span className="text-[#166534] relative inline-block">Preserving Its Value.</span>
              </h1>
              ...
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed max-w-xl ">
                At Prajha Group, we provide comprehensive property management solutions designed to protect, maintain, and maximize the value of your real estate. From flats and luxury villas to plots, farm lands, and gated communities, our dedicated team handles every essential aspect of property management with transparency, reliability, and care.
              </p>
